...
The canonical Genesis-Locked Invariants live in [`genesis/INVARIANTS.md`](../genesis/INVARIANTS.md). The native-currency invariants below are part of the canonical eighteen and reproduced here for narrative cohesion. Numbering matches `genesis/INVARIANTS.md`.
...
These invariants are hash-committed to the AO Core at native-currency launch and carry the same protection as the canonical eighteen.
