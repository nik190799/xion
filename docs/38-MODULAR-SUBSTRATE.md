...
| Settlement chain / treasury rail | `orchestrator/treasury/settlement_gateway.py::SettlementChain` | `BaseEvmSettlementChain`; `ArweaveSettlementChain` | deeper AR balance/broadcast probes once mainnet custody is active | `KW-TREASURY-CHAIN-001` closed for provider-depth; live custody remains Epic C deploy/audit work |
