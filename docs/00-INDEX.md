...
| — | [`HERMES_PIN_PROTOCOL.md`](./HERMES_PIN_PROTOCOL.md) | Effect-based governance for Hermes pins, Agent Souls, tool allowlists, and cast-ledger verification | engineers, auditors |
| 25 | [`SUBSTRATE-RESILIENCE.md`](./SUBSTRATE-RESILIENCE.md) | **How Xion outlives any one substrate** — substrate threat model, Substrate Portability Property, Substrate-Migration Protocol, path to future Invariant 20 | engineers, governance, anyone with horizon > 10 years |
...
| 39 | [`35-CONTRIBUTOR-HANDBOOK.md`](./35-CONTRIBUTOR-HANDBOOK.md) | **Contributor Handbook** — practical workflow for humans and coding assistants using `which-level`, `mcp-export`, and identity bindings | contributors |
| 40 | [`MEASUREMENT-VOCABULARY.md`](./MEASUREMENT-VOCABULARY.md) | **Measurement Vocabulary** — runway-weeks, fund fractions, evidence counts, and the ban on time/money shortcuts for spend authority | engineers, governance, auditors |
| 41 | [`SPEND-AUTONOMY.md`](./SPEND-AUTONOMY.md) | **Spend Autonomy** — S1-S5 authority postures, runway modes, inflow-tag-only rule, and verifier-backed spend discipline under Invariant 19 | engineers, governance, treasury ops |
| 42 | [`41-CENTRALIZED-REMOVAL.md`](./41-CENTRALIZED-REMOVAL.md) | **Centralized Provider Removal** — removal record for OpenAI/OpenRouter runtime paths, Chutes/Bittensor replacement posture, and sovereign verifier | engineers, auditors |
| — | [`34-SOVEREIGN-PROFILE.md`](./34-SOVEREIGN-PROFILE.md) | **Sovereign Profile** — `XION_PROFILE=sovereign` refusal table and boot-time centralized-surface fence | operators, engineers |
