...
- **Mitigations:**
  ...
  4. `docs/26-INFERENCE-POLICY.md` § "Genesis Defaults" documents that the OpenRouter API key is an operator-supplied credential — if the operator unsets it, the Router falls back to the floor provider, removing the runaway-cost risk at the cost of quality.
