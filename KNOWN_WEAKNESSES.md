...
- **Discovered:** 2026-04-22 (Phase 5g-iv admission-control landing)
- **Severity:** low
- **Status:** `pending-closure` — Phase 5g+ doctrine lands in Commit 1; `BrokerBackedSlidingWindow` wires in Commit 4; this KW moves to **Closed** in Commit 5. See [`docs/04-ARCHITECTURE.md`](./docs/04-ARCHITECTURE.md) § "Multi-worker coherence (Phase 5g+)" and [`docs/33-MULTI-WORKER.md`](./docs/33-MULTI-WORKER.md).
...
- **Severity:** low
- **Status:** `pending-closure` — Phase 5g+ doctrine lands in Commit 1; `SqliteBroker` module + leader election wire in Commits 2-3; this KW moves to **Closed** in Commit 5. See [`docs/04-ARCHITECTURE.md`](./docs/04-ARCHITECTURE.md) § "Multi-worker coherence (Phase 5g+)" and [`docs/33-MULTI-WORKER.md`](./docs/33-MULTI-WORKER.md).
