...
- **Status:** `mitigated-residual` — **Sprint Mode unaudited posture explicitly accepted on 2026-05-10** with a 90-day re-review checkpoint at **2026-08-08**. Path (b) of the prior pay-down line was chosen by the operator because external-audit budget (USD 30–60k anchor) was not available. Status returns to `open` if the 2026-08-08 review does not either commission an audit or post a new dated slip.
...
- **Mitigations:**
  ...
  - **2026-05-10:** External-audit RFP authored at `docs/audits/RFP_TREASURY_2026.md` (recipient short-list, cover email, scope, budget bracket, contact). The RFP is held in repo as a ready-to-send artifact for the next budget cycle; sending was explicitly deferred 2026-05-10 by the operator.
