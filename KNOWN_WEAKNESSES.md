...
- **Verifier:** `xion-verify web-client` (ships `NOT_YET_SEALED` at 5g-v; promotes to live at first operator deployment of a built `dist/`). The Vitest + axe-core client-side suite is live at 5g-v and covers the envelope-handling matrix.
