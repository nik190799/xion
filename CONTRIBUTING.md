...
1. **Scaffold:** Use the `xion new` CLI commands (`skill`, `sense`, `provider`, `verifier`, `proposal`) to generate a working skeleton. *(Note: `xion new` CLI is scheduled to land in Phase 6.2)*
