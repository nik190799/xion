...
_UNSEALED = (
    ...
    StubSpec("refusal-rate", "Rolling-30-day Arbiter refusal rate vs adversarial-corpus expectation band.",
             "Arbiter + SAFETY_LEDGER not yet live.", "Phase 4"),
    ...
    StubSpec("refund-fidelity", "Every Covenant refusal has a correlation_id-paired refund.",
             "Relay + Arbiter not yet wired to refund flow.", "Phase 4/5"),
