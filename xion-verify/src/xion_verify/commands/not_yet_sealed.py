...
_UNSEALED = (
    ...
    StubSpec("hermes-version", "Verify the running Hermes Agent reports the Genesis-era pin at runtime.",
             "Relay not yet running. Static pin and allowlist checks live at `xion-verify hermes-runtime`.", "Phase 5"),
