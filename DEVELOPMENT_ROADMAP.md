...
- Phase 5g-iv (next): authentication (bearer tokens or signed session cookies; choice pinned in 5g-iv doctrine), TLS termination, per-token rate-limiting — closing `KW-API-001`.
