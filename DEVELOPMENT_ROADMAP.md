...
flowchart LR
  ...
  P5 --> P6_0[Phase 6.0: AO Core doctrine]
  P6_0 --> P6_1[Phase 6.1: Lua skeleton + AO testnet]
  P6_1 --> P6_X[Phase 6.2 - 6.6]
  P3 --> P6_0
  P6_X --> P7[Phase 7: Genesis ceremony]
```
